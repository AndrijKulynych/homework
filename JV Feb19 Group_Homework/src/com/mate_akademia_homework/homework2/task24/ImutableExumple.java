package com.mate_akademia_homework.homework2.task24;

import java.util.Date;

public class ImutableExumple {
    ...
    static final class Car{
        ...
        public Date getDate_produce () {
             return (Date) date_produce.clone();
        }

        public Car (String marka, String model, double runVolume, int runPower, Date date_produce) {
            this.marka = marka;
            this.model = model;
